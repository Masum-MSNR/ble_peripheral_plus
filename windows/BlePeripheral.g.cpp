...
void BlePeripheralChannel::SetUp(
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.ble_peripheral_plus.BlePeripheralChannel.initialize", &GetCodec());
    if (api != nullptr) {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.ble_peripheral_plus.BlePeripheralChannel.isAdvertising", &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.ble_peripheral_plus.BlePeripheralChannel.isSupported", &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.ble_peripheral_plus.BlePeripheralChannel.stopAdvertising", &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.ble_peripheral_plus.BlePeripheralChannel.askBlePermission", &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.ble_peripheral_plus.BlePeripheralChannel.addService", &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.ble_peripheral_plus.BlePeripheralChannel.removeService", &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.ble_peripheral_plus.BlePeripheralChannel.clearServices", &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.ble_peripheral_plus.BlePeripheralChannel.getServices", &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.ble_peripheral_plus.BlePeripheralChannel.updateCharacteristic", &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
...
void BleCallback::OnReadRequest(
  ...
  const std::string channel_name = "dev.flutter.pigeon.ble_peripheral_plus.BleCallback.onReadRequest";
...
void BleCallback::OnWriteRequest(
  ...
  std::function<void(const FlutterError&)>&& on_error) {
  const std::string channel_name = "dev.flutter.pigeon.ble_peripheral_plus.BleCallback.onWriteRequest";
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
    EncodableValue(device_id_arg),
    EncodableValue(characteristic_id_arg),
...
void BleCallback::OnCharacteristicSubscriptionChange(
  ...
  std::function<void(const FlutterError&)>&& on_error) {
  const std::string channel_name = "dev.flutter.pigeon.ble_peripheral_plus.BleCallback.onCharacteristicSubscriptionChange";
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
    EncodableValue(device_id_arg),
    EncodableValue(characteristic_id_arg),
...
void BleCallback::OnAdvertisingStatusUpdate(
  ...
  std::function<void(void)>&& on_success,
  std::function<void(const FlutterError&)>&& on_error) {
  const std::string channel_name = "dev.flutter.pigeon.ble_peripheral_plus.BleCallback.onAdvertisingStatusUpdate";
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void BleCallback::OnBleStateChange(
  ...
  std::function<void(void)>&& on_success,
  std::function<void(const FlutterError&)>&& on_error) {
  const std::string channel_name = "dev.flutter.pigeon.ble_peripheral_plus.BleCallback.onBleStateChange";
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void BleCallback::OnServiceAdded(
  ...
  std::function<void(void)>&& on_success,
  std::function<void(const FlutterError&)>&& on_error) {
  const std::string channel_name = "dev.flutter.pigeon.ble_peripheral_plus.BleCallback.onServiceAdded";
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void BleCallback::OnMtuChange(
  ...
  std::function<void(void)>&& on_success,
  std::function<void(const FlutterError&)>&& on_error) {
  const std::string channel_name = "dev.flutter.pigeon.ble_peripheral_plus.BleCallback.onMtuChange";
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
    EncodableValue(device_id_arg),
...
void BleCallback::OnConnectionStateChange(
  ...
  std::function<void(void)>&& on_success,
  std::function<void(const FlutterError&)>&& on_error) {
  const std::string channel_name = "dev.flutter.pigeon.ble_peripheral_plus.BleCallback.onConnectionStateChange";
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
    EncodableValue(device_id_arg),
...
void BleCallback::OnBondStateChange(
  ...
  std::function<void(void)>&& on_success,
  std::function<void(const FlutterError&)>&& on_error) {
  const std::string channel_name = "dev.flutter.pigeon.ble_peripheral_plus.BleCallback.onBondStateChange";
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
    EncodableValue(device_id_arg),
